...
<section id="contact" class="contact-section section-padding" aria-labelledby="contact-title">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div class="reveal-left contact-info-panel">
                ...
                <div class="space-y-6">
                    <h3 class="font-display font-bold text-sm uppercase tracking-wide text-white/80"><?= e($t['contact']['info_title']) ?></h3>
                    ...
                    <div class="contact-info-item">
                        ...
                        <div>
                            <p class="font-medium text-white"><?= e($t['contact']['address']) ?></p>
                            <p class="text-sm text-white/50 mt-1"><?= e($t['contact']['hours']) ?></p>
                        </div>
                    </div>
                    ...
                    <div class="contact-info-item">
                        ...
                        <a href="tel:<?= e(preg_replace('/\s+/', '', SITE_PHONE)) ?>" class="font-medium text-white hover:text-accent transition-colors"><?= e(SITE_PHONE) ?></a>
                    </div>
                    ...
                    <div class="contact-info-item">
                        ...
                        <a href="mailto:<?= e(SITE_EMAIL) ?>" class="font-medium text-white hover:text-accent transition-colors"><?= e(SITE_EMAIL) ?></a>
                    </div>
                </div>
            </div>
                ...
                <form id="contact-form" class="contact-form" action="contact-form.php" method="POST" novalidate>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div class="form-group">
                            <label for="name" class="form-label"><?= e($t['contact']['name']) ?> <span class="text-accent">*</span></label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div class="form-group">
                            <label for="email" class="form-label"><?= e($t['contact']['email']) ?> <span class="text-accent">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="phone" class="form-label"><?= e($t['contact']['phone']) ?> <span class="text-accent">*</span></label>
                    ...
                    <button type="submit" class="btn-primary btn-lg w-full group">
                        <?= e($t['contact']['submit']) ?>
