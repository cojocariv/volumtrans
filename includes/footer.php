    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-white/60 text-sm leading-relaxed mb-6"><?= e($t['footer']['about']) ?></p>
            ...
            <!-- Quick Links -->
            <div>
                <h3 class="font-display font-semibold text-sm uppercase tracking-wider text-white/90 mb-6"><?= e($t['footer']['quick_links']) ?></h3>
            ...
            <!-- Services -->
            <div>
                <h3 class="font-display font-semibold text-sm uppercase tracking-wider text-white/90 mb-6"><?= e($t['footer']['services']) ?></h3>
                <ul class="space-y-3" role="list">
            ...
            <!-- Contact -->
            <div>
                <h3 class="font-display font-semibold text-sm uppercase tracking-wider text-white/90 mb-6"><?= e($t['footer']['contact']) ?></h3>
                <ul class="space-y-4" role="list">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-white/60 text-sm"><?= e($t['contact']['address']) ?></span>
                    </li>
                    ...
                    <li class="flex items-center gap-3">
                        <svg class="w-5 h-5 text-accent shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
        ...
        <div class="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-white/40 text-sm">&copy; <?= date('Y') ?> <?= e(SITE_NAME) ?>. <?= e($t['footer']['rights']) ?></p>
            <div class="flex items-center gap-6">
                <a href="#" class="text-white/40 hover:text-accent text-sm transition-colors"><?= e($t['footer']['privacy']) ?></a>
                <a href="#" class="text-white/40 hover:text-accent text-sm transition-colors"><?= e($t['footer']['terms']) ?></a>
            </div>
        </div>
    </div>
</footer>
